...
async def initiate_milestone_checks(player_class, universe_title=None): 
    ...
    if universe_title:
        ...
        if not universe_exists:
            ...
            damage_check = [
                (1000, 1000), (5000, 5000), (10000, 10000), (50000, 50000),
                (100000, 100000), (500000, 500000), (1000000, 1000000),
                (5000000, 2500000), (10000000, 5000000), (50000000, 10000000),
                (100000000, 25000000), (500000000, 50000000), (1000000000, 100000000)
            ]
    ...
    if not milestones_exist:
        ...
        milestone_templates = [
            ...
            },
            {
                "TYPE": "TUTORIAL",
                "milestones": [
                    (1, 50000, "Tutorial Milestone"), 
                    (2, 100000, "Tutorial Student Milestone"), 
                    (3, 250000, "Tutorial Graduate Milestone"), 
                    (4, 500000, "Tutorial Expert Milestone"), 
            ...
            },
            {
                "TYPE": "BLACKSMITH",
                "milestones": [
                    (1, 100000, "Blacksmith Student Milestone"), 
                    (5, 250000, "Blacksmith Mastery Milestone"), 
                    (15, 500000, "Blacksmith Expert Milestone"), 
                    (50, 1000000, "Blacksmith Master Milestone"), 
                    (100, 10000000, "Blacksmith God Milestone")
                ]
            },
            {
                "TYPE": "ROLL",
                "milestones": [
                    (1, 10000, "First Rolls Milestone"), 
                    (5, 20000, "5 Rolls Milestone"), 
                    (10, 30000, "10 Rolls Milestone"), 
                    (25, 40000, "25 Rolls Milestone"), 
                    (50, 50000, "50 Rolls Milestone"), 
                    (80, 75000, "80 Rolls Milestone"), 
                    (100, 100000, "100 Rolls Milestone"), 
                    (150, 125000, "150 Rolls Milestone"), 
                    (180, 150000, "180 Rolls Milestone"), 
                    (200, 200000, "200 Rolls Milestone"), 
                    (250, 250000, "250 Rolls Milestone"), 
                    (300, 300000, "300 Rolls Milestone"), 
                    (500, 400000, "500 Rolls Milestone"), 
                    (750, 500000, "750 Rolls Milestone"), 
                    (1000, 1000000, "1000 Rolls Milestone"), 
                    (1500, 2000000, "1500 Rolls Milestone"), 
                    (2000, 5000000, "2000 Rolls Milestone"), 
                ]
            },
            {
                "TYPE": "DAILY",
                "milestones": [
                    ...
                    (5, 600000, "Daily Consistency Milestone"), 
                    (10, 1200000, "Daily Boom Milestone"), 
                    (15, 1500000, "Daily Boom Boom Milestone"), 
                    (20, 2000000, "Daily Boom Boom Boom Milestone"), 
                    (30, 3000000, "Daily Execution Milestone"), 
                    (40, 4000000, "Daily Executioner Milestone"), 
                    (50, 5000000, "Daily Executioner 2 Milestone"), 
                    (60, 7500000, "Daily Executioner 3 Milestone"), 
                    (70, 10000000, "Daily Executioner 4 Milestone"), 
                    (80, 15000000, "Daily Executioner 5 Milestone"), 
                    (100, 30000000, "Master of Daily Milestones"), 
                    (130, 40000000, "Master of Daily Milestones 2"), 
                    (150, 50000000, "Master of Daily Milestones 3"), 
                    (200, 100000000, "Master of Daily Milestones 4"), 
                    (250, 200000000, "Master of Daily Milestones 5"), 
                    (300, 300000000, "Master of Daily Milestones 6"), 
                    (380, 400000000, "Master of Daily Milestones 7"), 
                    (400, 500000000, "Master of Daily Milestones 8"), 
                    (500, 1000000000, "Master of Daily Milestones 9"), 
                    (600, 2000000000, "Master of Daily Milestones 10"), 
                    (700, 3000000000, "Master of Daily Milestones 11"), 
                    (1000, 5000000000, "God of Daily Milestones")
                ]
            },
            {
                "TYPE": "DONATION",
                "milestones": [
                    ...
                    (500000, 200000, "Guild Investor 2 Milestone"), 
                    (1000000, 500000, "Guild Investor 3 Milestone"), 
                    (10000000, 1000000, "Guild Investor 4 Milestone"), 
                    (25000000, 10000000, "The Guild Comes First! Milestone"), 
                    (100000000, 25000000, "The Guild Comes First! 2 Milestone"), 
                    (250000000, 50000000, "The Guild Comes First! 3 Milestone"), 
                    (500000000, 200000000, "The Guild Comes First! 4 Milestone"), 
                    (1000000000, 500000000, "Through The Wire! Milestone"), 
                    (10000000000, 1000000000, "Through The Wire! 2 Milestone"), 
                    (50000000000, 10000000000, "Through The Wire! 3 Milestone"), 
                    (100000000000, 25000000000, "Through The Wire! 4 Milestone"), 
                    (500000000000, 100000000000, "Guild God! Milestone"), 
                    (1000000000000, 100000000000, "Guild God 2! Milestone"), 
                    (25000000000000, 1000000000000, "Guild God 3! Milestone"), 
                    (100000000000000, 25000000000000, "Guild God 4! Milestone"), 
                    (1000000000000000, 100000000000000, "Guild God 5! Milestone")
                ]
            }
        ]

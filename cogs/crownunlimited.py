                        ...
                        if battle_config.is_turn == 0:
                            ...
                            if player1_card.stamina < 10:
                                ...
                                if battle_config.is_auto_battle_game_mode:                                    
                                    ...
                                    await asyncio.sleep(2)
                                    if player1.performance:
                                        embedVar.add_field(name=f":sunny: **Move Set**", value=f"{player1_card.resolve_icon} {player1_card.stamina}\n{player1_card.move1_emoji}{player1_card.move1ap} *-10 ST*\n{player3_card.move2_emoji}{player1_card.move2ap} *-30 ST*\n{player1_card.move3_emoji}{player1_card.move3ap} *-80 ST*\n:microbe:{player1_card.move4enh} {player1_card.move4ap} *-20 ST*")
                            ...
                            if player2_card.stamina < 10:
                                ...
                                if battle_config.is_pvp_game_mode and not battle_config.is_tutorial_game_mode:
                                    ...
                                    if not battle_config.is_ai_opponent:
                                        ...
                                        await asyncio.sleep(1)
                                        if player2.performance:
                                            embedVar.add_field(name=f":sunny: **Move Set**", value=f"{player2_card.resolve_icon} {player2_card.stamina}\n{player2_card.move1_emoji}{player2_card.move1ap} *-10 ST*\n{player2_card.move2_emoji}{player2_card.move2ap} *-30 ST*\n{player2_card.move3_emoji}{player2_card.move3ap} *-80 ST*\n:microbe:{player2_card.move4enh} {player2_card.move4ap} *-20 ST*")
                                            battle_msg = await private_channel.send(embed=embedVar, components=components)
                                        else:
                                ...
                                if player3_card.stamina < 10:
                                    ...
                                    if battle_config.is_auto_battle_game_mode or battle_config.is_duo_mode:
                                        if battle_config.is_duo_mode:
                                            ...
                                            await asyncio.sleep(2)
                                            if player1.performance:
                                                embedVar.add_field(name=f":sunny: **Move Set**", value=f"{player3_card.resolve_icon} {player3_card.stamina}\n{player3_card.move1_emoji}{player3_card.move1ap} *-10 ST*\n{player3_card.move2_emoji}{player3_card.move2ap} *-30 ST*\n{player3_card.move3_emoji}{player3_card.move3ap} *-80 ST*\n:microbe:{player3_card.move4enh} {player3_card.move4ap} *-20 ST*")
                                                battle_msg = await private_channel.send(embed=embedVar)
                                            else:

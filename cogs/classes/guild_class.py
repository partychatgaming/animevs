...
class Guild:
    def __init__(self, owner, members, guild_name, guild_display_name, officers, captains, transactions, storage, guild_buff_available, guild_buff_on, active_guild_buff, guild_buffs, association, bank, wins, losses, badges, guild_mission, completed_missions, member_count, war_flag, war_opponent, shielding):
        self.owner = owner
        self.members = members
        self.guild_name = guild_name
        self.guild_display_name = guild_display_name
        self.officers = officers
        self.captains = captains
        self.transactions = transactions
        self.storage = storage
        self.guild_buff_available = guild_buff_available
        self.guild_buff_on = guild_buff_on
        self.active_guild_buff = active_guild_buff
        self.guild_buffs = guild_buffs
        self.association = association
        self.bank = bank
        self.wins = wins
        self.losses = losses
        self.badges = badges
        self.guild_mission = guild_mission
        self.completed_missions = completed_missions
        self.member_count = member_count
        self.war_flag = war_flag
        self.war_opponent = war_opponent
        ...
        self.formatted_list_of_members = []
        self.formatted_list_of_officers = []
        self.formatted_list_of_captains = []

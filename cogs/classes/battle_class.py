...
class Battle:
    ...
    def get_tutorial_message(self, player_card):
        ...
        if player_card.is_summoner and not self.tutorial_focus:
            return f"{basic_task}| Use 10 {player_card.move1_emoji} / {special_task}| Use 30 {player_card.move2_emoji}\n{ultimate_task}| Use 80 {player_card.move3_emoji} / {enhancer_task}| Use 20 🦠\n{block_task}| Use 🛡️ Block 20\n{focus_task}| Enter First Focus\n{summon_task}| Use 🧬"
        if self.tutorial_focus == True and self.tutorial_resolve == True:
            return f"{basic_task}| Use 10 {player_card.move1_emoji} / {special_task}| Use 30 {player_card.move2_emoji}\n{ultimate_task}| Use 80 {player_card.move3_emoji} / {enhancer_task}| Use 20 🦠\n{block_task}| Use 🛡️ Block 20\n{focus_task}| Enter First Focus\n{resolve_task}| Use ⚡Resolve!\n{summon_task}| Use 🧬"
    ...
    def configure_player_1(self):
        try:
            # Refresh player1's data to get updated card levels

...
def evolutions(player_card, battle_config, player_title):
    if player_card.universe == "Kanto Region" or player_card.universe == "Johto Region" or player_card.universe == "Hoenn Region" or player_card.universe == "Sinnoh Region" or player_card.universe == "Kalos Region" or player_card.universe == "Unova Region" or player_card.universe == "Alola Region" or player_card.universe == "Galar Region":  # Pokemon Resolves
        ...
        if battle_config.turn_total >= 50:
            ...
            battle_config.add_to_battle_log(f"(**{battle_config.turn_total}**) **{player_card.name}** 🩸 Resolved: Gigantomax Evolution!!! Gained **1000** HP!!!{title_message}")
            ...
            battle_config.add_to_battle_log(f"(**{battle_config.turn_total}**) **{player_card.name}** 🩸 Resolved: Mega Evolution!! Gained **500** HP!{title_message}")
        else:
            battle_config.add_to_battle_log(f"(**{battle_config.turn_total}**) **{player_card.name}** 🩸 Resolved: Evolution!{title_message}")

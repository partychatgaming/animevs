...
soul_reaper = "**Soul Reaper:**\n*Shikai*: On Resolve: Gain +ATK/DEF × Blitz Count *Bankai*: Execute: (Turn × Blitz × Tier) true dmg"
quincy = " **Quincy:**\n*Vollständig*: On Resolve: If player Blitzed during battle gain, 2×Ult AP; else +50% AP. -25% DEF *Schrift*: Execute: Full heal"
hollow = "**Hollow:**\n*Resurrección*: On Resolve: Gain AP, ATK, DEF by LVL *Segunda Etapa*: Execute: Critical Strikes >50% HP"
fullbringer = "**Fullbringer:**\n*Fullbring Activation*: On Resolve: Gain +200 Stamina, Extend Focus Buffs *Fullbring Completion*: Execute: +ATK/DEF by Stamina × Tier"
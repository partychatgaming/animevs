traits = [{
    ...
    'TRAIT': 'Scheduled Death : Your First Focus After Scheduled Death [24 + (24 * Card Tier)] Turns You Win. Shinigami Eyes : On Block, Sacrifice 5% Max Health to Increase Turn by (3 + Card Tier).'
},{
    'NAME': 'Dragon Ball Z',

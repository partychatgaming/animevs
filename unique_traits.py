traits = [{
    ...
    'TRAIT': '**Mana Zone** : Gain 100 Stamina on Focus. **Grimoire** : AP is increased by (30 + turn Count) on Focus.'
},{
    'NAME': 'Fate',
    'EFFECT': 'Command Seal',
    ...
    'TRAIT': '**Hero Rankings** : On Focus gain (10 * Card Tier) AP. **Hero Reinforcement** : On Opp Focus you create (100 * Card Tier) Health. '
},{
    'NAME': 'Solo Leveling',
